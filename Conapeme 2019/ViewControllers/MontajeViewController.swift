...
class MontajeViewController:UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let pdf = Bundle.main.url(forResource: "montaje", withExtension: "pdf", subdirectory: nil, localization: nil)  {
